...
import com.api.dto.JoinMessage;
import com.api.dto.PlayerMessage;
import com.api.dto.TicTacToeMessage;
	        ...
	        if (game != null) {
	            if (game.getPlayer1().equals(player)) {
	                ...
	                if (game.getPlayer2() != null) {
	                    game.setGamestate(GameState.PLAYER2_WON);    // .getGamestate(GameState.PLAYER2_WON);
